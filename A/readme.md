...
### Download Dataset
Open and RUN [`generate_dataset.py`](https://github.com/bcirepo/BCITransformer/blob/main/A/generate_dataset.py) code through the PyCharm IDE.
...
The code for training and evaluating this paradigm is inside [`main.py`](https://github.com/bcirepo/BCITransformer/blob/main/A/main.py). 
